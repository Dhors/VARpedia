...
step2a: The jar file can be run the included run.sh script by typing the the command "./run.sh" into terminal. the run.sh script file must be in the same folder as the jar file.

step2b: alternativly, The jar file can be run by typing the following two commands into terminal:
